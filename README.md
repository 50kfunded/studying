...
- put your songs in a `music` folder on your desktop. it plays them in file name order, or you can press shuffle.
...
- keep the discord desktop app open. right click the **discord activity** bar in the app, choose **discord setup**, and paste your discord application id. if youre using your own discord app, add `assets/studying-photo.png` as a rich presence image named `studying-photo` to show the art.
